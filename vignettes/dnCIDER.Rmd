---
title: "Perform meta-clustering (dnCIDER) on pancreas data"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Perform meta-clustering (dnCIDER) on pancreas data}
...
mclust::adjustedRandIndex(seu$CIDER_cluster, seu$Group)
```
